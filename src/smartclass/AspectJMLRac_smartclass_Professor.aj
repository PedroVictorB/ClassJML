...
privileged aspect AspectJMLRac_smartclass_Professorb270b433_dc2e_4025_ab73_51e95cc2df79 {
 ...
 declare precedence: AspectJMLRac_*, *;
  ...
  after (final smartclass.Professor object$rac) returning (final java.lang.String rac$result) :
     (execution(java.lang.String smartclass.Professor.getName())) && this(object$rac) {
       ...
       String evalErrorMsg = "";
       boolean rac$b = true;
         nPostErrorMsg =  "by method smartclass.Professor.getName regarding code at \nFile \"smartclass.Professor.java\", line 32 (smartclass.Professor.java:32)";
  ...
  /** Generated by AspectJML to check the exceptional postcondition of
   * method setName. */
  after (final smartclass.Professor object$rac, final java.lang.String name) throwing (Throwable rac$e) :
     (execution(void smartclass.Professor.setName(java.lang.String))) && this(object$rac) && args(name) {
  ...
  before (final smartclass.Professor object$rac) :
     ...
     this(object$rac) {
         String invErrorMsg = "@pre <File \"Professor.java\"> regarding code at \nFile \"Professor.java\"\nnon_null for field 'name' <File \"smartclass.Professor.java\", line 15, character 25 (smartclass.Professor.java:15)>\nnon_null for field 'temperature' <File \"smartclass.Professor.java\", line 16, character 31 (smartclass.Professor.java:16)>\n\nnon_null for field 'slides' <File \"smartclass.Professor.java\", line 18, character 25 (smartclass.Professor.java:18)>";
         String evalErrorMsg = "Invalid expression in \"@pre <File \"Professor.java\"> regarding code at \nFile \"Professor.java\"\nnon_null for field 'name' <File \"smartclass.Professor.java\", line 15, character 25 (smartclass.Professor.java:15)>\nnon_null for field 'temperature' <File \"smartclass.Professor.java\", line 16, character 31 (smartclass.Professor.java:16)>\n\nnon_null for field 'slides' <File \"smartclass.Professor.java\", line 18, character 25 (smartclass.Professor.java:18)>\nCaused by: ";
         boolean rac$b = true;
         try {
          rac$b = ((object$rac.slides != null) && ((object$rac.temperature != null) && (object$rac.name != null)));
         } catch (JMLNonExecutableException rac$nonExec) {
            rac$b = false;
         } catch (Throwable rac$cause) {
            if(rac$cause instanceof JMLAssertionError) {
  ...
  /** Generated by AspectJML to check the precondition of
   * method setName. */
  before (final smartclass.Professor object$rac, final java.lang.String name) :
     (execution(void smartclass.Professor.setName(java.lang.String))) && 
     this(object$rac) && args(name) {
       String preErrorMsg = "by method smartclass.Professor.setName regarding code at \nFile \"smartclass.Professor.java\""+", when \n"+"\t\'name\' is "+name+ ", when \n"+"\t\'name\' is "+name;
       String evalErrorMsg = "Invalid expression in \"smartclass.Professor.java\"\nCaused by: ";
       boolean rac$b = true;
       try {
        rac$b = (name != null);
