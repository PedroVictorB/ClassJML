...
privileged aspect AspectJMLRac_smartclass_services_AirService2dcff515_72b3_4bb3_84a9_75a13f58768d {
 ...
 declare precedence: AspectJMLRac_*, *;
   ...
   * method AirService. */
  after (final smartclass.services.AirService object$rac, final context.arch.widget.Widget widget) throwing (Throwable rac$e) :
     execution(smartclass.services.AirService.new( context.arch.widget.Widget )) && this(object$rac) && args(widget) {
           JMLChecker.rethrowJMLAssertionError(rac$e, "smartclass.services.AirService.<init>(context.arch.widget.Widget)");
           boolean rac$b = true;
           String rac$ErrorMsg = "";
  		   ...
  		   if (true) {
  		     if (rac$e instanceof java.lang.RuntimeException) {
  			   ...
  			   try{			     
  			     ...
  			     throw new JMLEvaluationError("Invalid Expression in \"smartclass.services.AirService.java\" by method smartclass.services.AirService.<init>\nCaused by: "+rac$e);
  			   }
  			   if(!rac$b0) {
           ...
           if(rac$ErrorMsg.indexOf("and") >= 0 ){
             ...
             rac$ErrorMsg += " is ";
               ...
               JMLChecker.checkExceptionalPostcondition(rac$b,"by method smartclass.services.AirService.<init> regarding code at \nFile \"smartclass.services.AirService.java\""+"\n\t"+rac$ErrorMsg+rac$e, "jml$ex", true, -1, "smartclass.services.AirService.<init>(context.arch.widget.Widget)", rac$e);
  		 }
  		   }
  	 }
   ...
   * method execute. */
  after (final smartclass.services.AirService object$rac, final context.arch.service.helper.ServiceInput si) returning (final context.arch.comm.DataObject rac$result) :
     (execution(context.arch.comm.DataObject smartclass.services.AirService.execute(context.arch.service.helper.ServiceInput))) && this(object$rac) && args(si) {
  ...
  /** Generated by AspectJML to check the exceptional postcondition of
   * method execute. */
  after (final smartclass.services.AirService object$rac, final context.arch.service.helper.ServiceInput si) throwing (Throwable rac$e) :
     (execution(context.arch.comm.DataObject smartclass.services.AirService.execute(context.arch.service.helper.ServiceInput))) && this(object$rac) && args(si) {
  		   ...
  		   if (true) {
  		     if (rac$e instanceof java.lang.RuntimeException) {
  			   ...
  			   try{			     
  			     ...
  			     throw new JMLEvaluationError("Invalid Expression in \"smartclass.services.AirService.java\" by method smartclass.services.AirService.execute\nCaused by: "+rac$e);
  			   }
  			   if(!rac$b0) {
  			     if(rac$ErrorMsg.equals("")) {
  			       rac$ErrorMsg = "jml$ex";
   ...
   * method AirService. */
  before (final smartclass.services.AirService object$rac, final context.arch.widget.Widget widget) :
     execution(smartclass.services.AirService.new( context.arch.widget.Widget )) && 
     this(object$rac) && args(widget) {
       String preErrorMsg = "by method smartclass.services.AirService.<init> regarding code at \nFile \"smartclass.services.AirService.java\""+", when \n"+"\t\'widget\' is "+widget+ ", when \n"+"\t\'widget\' is "+widget;
       ...
       JMLChecker.checkPrecondition(rac$b, canThrow, preErrorMsg, -1, "smartclass.services.AirService.<init>(context.arch.widget.Widget)");
  ...
  /** Generated by AspectJML to enable modular signals_only checking (XCS enabled) */
    after(final smartclass.services.AirService object$rac): (execution( * smartclass.services.AirService..*+.*(..))
            || execution(smartclass.services.AirService..*+.new(..))
            || execution( * smartclass.services.AirService+.*(..))
            || execution(smartclass.services.AirService+.new(..))) && 
     this(object$rac) {
  ...
  /** Generated by AspectJML to enhance error reporting (Execution Site enabled) */
    after() throwing (Throwable rac$e): (execution( * smartclass.services.AirService..*+.*(..))
            || execution(smartclass.services.AirService..*+.new(..))
            || execution( * smartclass.services.AirService+.*(..))
            || execution(smartclass.services.AirService+.new(..))){
  ...
  public static aspect UtilPreconditionChecking_AirService{
    before(): (execution( * smartclass.services.AirService..*+.*(..))
            || execution(smartclass.services.AirService..*+.new(..))
            || execution( * smartclass.services.AirService+.*(..))
            || execution(smartclass.services.AirService+.new(..))){
